...
`npm run dev`, `dev:local` und `build` prüfen das vorab und brechen mit einem entsprechenden
Hinweis ab, statt die fehlenden Links als Import-Fehler im Anwendungscode zu melden. Dieselbe
Prüfung lässt sich einzeln aufrufen:
