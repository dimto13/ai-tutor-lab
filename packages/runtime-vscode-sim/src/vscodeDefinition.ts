...
import type { RuntimeSurfaceDescription } from "@ai-train-lab/runtime-core";
...
export const VSCODE_RUNTIME_DEFINITION = {
  ...
  surface: [
    ...
    { ref: "vscode.menu.help", label: "Help-Menü", conceptKey: "vscode.help_menu" },
    {
      ...
      conceptKey: "vscode.command_palette",
    },
    { ref: "vscode.settings", label: "Settings", conceptKey: "vscode.settings" },
    {
