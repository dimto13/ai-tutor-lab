...
test(
  "Datentransparenz ist direkt aus dem Account erreichbar und beschreibt die realen Datenklassen",
  async ({ page, accessibility }) => {
    await page.goto("/");
...
test(
  "lokaler Eigendatenexport enthält nur die Browserdaten der angemeldeten Person",
  async ({ page }) => {
...
test(
  "Datentransparenz bleibt bei 320px tastatur- und screenreader-tauglich",
  async ({ page, accessibility }) => {
