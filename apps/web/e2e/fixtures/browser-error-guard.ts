...
const browserErrorAllowlist: readonly BrowserErrorAllowance[] = [
  {
    type: "console.error",
    pagePath:
      /^\/training\/(?:artifact-preview-foundation\.guided|brownfield-dashboard-repair\.guided|html-page-workflow\.(?:explore|guided|challenge)|quarterly-presentation-workflow\.guided)$/,
