...
type TrainingModeOption = { scenarioId: string; label: string; description: string; icon: LucideIcon; multiplier: string };
type TrainingCardModel = { id: string; scenarioId: string | null; modes?: TrainingModeOption[]; title: string; description: string; steps?: number; icon: LucideIcon; available: boolean; label?: string };

const toolTrainings: TrainingCardModel[] = [
  { id: "vscode-basics", scenarioId: null, title: "Visual Studio Code – Grundlagen", description: "Keine IT-Vorkenntnisse erforderlich. Lerne Oberfläche, Explorer, Suche, Command Palette, Datei/Ordner/Workspace, Editor und Speichern sowie Terminal, Problems, Output, Settings und Extensions kennen. Explore ca. 10 Min., Guided ca. 14 Min., Challenge ca. 8 Min.", icon: Code2, available: true, label: "IDE · 3 Modi + Speed Challenge", modes: [
...
const otherTrainings: TrainingCardModel[] = [{ id: "m365-copilot-basics", scenarioId: null, title: "M365 Copilot Grundlagen", description: "Den Microsoft-365-Copilot-Chat mit freigegebenem Work-Kontext, klaren Arbeitsaufträgen, Quellenprüfung und expliziter menschlicher Freigabe einsetzen. Alle Inhalte sind synthetisch.", icon: Bot, available: true, label: "Office Assistant · 3 Modi", modes: [
