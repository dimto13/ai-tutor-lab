...
export const Route = createFileRoute("/impressum")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Anbieterkennzeichnung für AI Training Lab." },
    ],
  }),
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-10">
        ...
        <article className="mt-6 rounded-xl border border-border bg-panel p-6 sm:p-8">
          <p className="text-xs font-semibold uppercase tracking-wide text-accent">Anbieterkennzeichnung</p>
          <h1 className="mt-2 text-2xl font-semibold tracking-tight text-foreground">Impressum</h1>
          <div className="mt-6 space-y-6 text-sm leading-relaxed text-foreground">
            <section aria-labelledby="provider-title">
              <h2 id="provider-title" className="font-semibold">Anbieter</h2>
              <address className="mt-2 not-italic text-muted-foreground">
                Tobias Freudling<br />
                Einzelunternehmen<br />
                Leopoldstraße 143<br />
                80804 München<br />
                Deutschland
              </address>
            </section>
            <section aria-labelledby="contact-title">
              <h2 id="contact-title" className="font-semibold">Kontakt</h2>
              <p className="mt-2 text-muted-foreground">
                E-Mail:{" "}
                <a className="underline underline-offset-4" href="mailto:dimto@online.de">dimto@online.de</a>
              </p>
            </section>
          </div>
        </article>
