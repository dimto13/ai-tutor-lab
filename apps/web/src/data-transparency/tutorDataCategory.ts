export interface TutorDataCategoryDescription {
  id: string;
  title: string;
  stored: string;
  storage: string;
 ...
 */
export const tutorDataCategory = {
  id: "tutor",
  title: "KI-Tutor",
  stored:
  ...
  storage:
    "Für Relay und Befehlsübermittlung wird Cloud-Infrastruktur des Anbieters in den USA verwendet. Die KI-Modelle laufen auf eigener Hardware des Anbieters. In der geschlossenen Beta werden ausschließlich lokale Modelle verwendet; eine externe Cloud-KI-Route ist nicht aktiviert.",
  recipients:
    "Empfänger sind die für Relay und Befehlsübermittlung eingesetzten Cloud-Dienste sowie die eigene Tutor-Infrastruktur des Anbieters. In der geschlossenen Beta erhält kein externer Cloud-KI-Anbieter deine Tutor-Frage.",
  retention:
...
} satisfies TutorDataCategoryDescription;
