...
export function CopilotPanel({ activeFile, onApplySuggestion }: CopilotPanelProps) {
  ...
  return (
    ...
    >
      ...
      {!chatVisible ? (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col items-center gap-3 py-3">
          <button
            type="button"
            onClick={toggleEnabled}
            aria-label={runtimeState.enabled ? "Copilot an" : "Copilot aus"}
        ...
        >
          ...
          <div className="mb-2 grid min-w-0 grid-cols-1 gap-2 sm:grid-cols-2">
            <label className="relative min-w-0 text-[10px] text-muted-foreground">
              Modus
              <select
          ...
          <label className="mb-2 block min-w-0 text-[10px] text-muted-foreground">
            Kontext
            <select
          ...
          {lastAssistantMessage ? (
            <div className="mb-2 max-h-32 min-w-0 overflow-y-auto rounded border border-border bg-editor p-2 text-xs leading-relaxed text-foreground/90">
          ...
          <div className="mt-3 min-w-0 border-t border-border pt-3">
            ...
            {visibleSuggestion ? (
              <div
                ...
                className="mt-2 min-w-0 rounded border border-border bg-editor p-2"
              >
                <pre className="whitespace-pre-wrap break-all font-mono text-[11px] text-success">
