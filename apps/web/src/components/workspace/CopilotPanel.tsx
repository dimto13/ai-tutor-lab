      ...
      <style>{`
        ...
        @media (max-width: 639px) {
          ...
          [data-highlight="vscode.secondarySideBar"]:has([data-highlight="copilot.chat"]) {
            flex: 0 0 min(22rem, calc(100vw - 3rem)) !important;
      ...
      {!runtimeState.chatOpen ? (
        ...
        >
          ...
          <div
            ...
            aria-label="Copilot-Unterhaltungsverlauf"
          >
            {runtimeState.messages.length === 0 ? (
              <div className="py-5 text-center text-xs text-muted-foreground">
                Wobei kann Copilot helfen?
              </div>
            ) : (
              <div className="space-y-3">
                {runtimeState.messages.map((message, index) => (
                  <div
                    ...
                    className={
                      message.role === "user"
                        ? "ml-4 rounded-lg bg-editor px-3 py-2 text-xs leading-relaxed text-foreground"
                        : "mr-2 text-xs leading-relaxed text-foreground/90"
                    }
                  >
                    {message.content}
                  </div>
          ...
          <div className="shrink-0 px-2 pb-2">
            <div className="rounded-lg border border-border bg-editor shadow-sm focus-within:border-ring">
              <div className="flex min-h-7 flex-wrap items-center gap-1 border-b border-border/70 px-2 py-1">
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded px-1.5 py-1 text-[10px] text-muted-foreground hover:bg-white/5 hover:text-foreground"
                >
                  <Plus className="h-3 w-3" /> Kontext
                </button>
                {runtimeState.contextActiveFile ? (
                  <span
                    ...
                    className="inline-flex min-w-0 items-center gap-1 rounded border border-accent/40 bg-accent/10 px-1.5 py-1 text-[10px] text-foreground"
                  >
              ...
              <textarea
                ...
                placeholder="Beschreiben, was erstellt werden soll"
                className="max-h-32 min-h-16 w-full resize-none bg-transparent px-3 py-2 text-xs leading-5 text-foreground outline-none"
              />
              <div className="flex min-w-0 items-center gap-1 px-2 pb-2">
                <label className="relative min-w-0">
                  ...
                  <select
                    ...
                    className="max-w-24 appearance-none rounded bg-transparent py-1 pl-1.5 pr-5 text-[10px] text-muted-foreground outline-none hover:bg-white/5 focus:ring-1 focus:ring-ring"
                  >
                  ...
                  <ChevronDown className="pointer-events-none absolute right-1 top-1.5 h-3 w-3 text-muted-foreground" />
                </label>
                <label className="relative min-w-0 flex-1">
                  ...
                  <select
                    ...
                    className="max-w-full appearance-none rounded bg-transparent py-1 pl-1.5 pr-5 text-[10px] text-muted-foreground outline-none hover:bg-white/5 focus:ring-1 focus:ring-ring"
                  >
                ...
                <button
                  ...
                  className="ml-auto rounded p-1.5 text-muted-foreground hover:bg-white/10 hover:text-foreground"
                >
            ...
            <div className="mt-1 flex items-center justify-between gap-2 px-1 text-[9px] text-muted-foreground">
              <span>Lokal</span>
              <span className="truncate">Standardgenehmigungen (Sandkasten)</span>
            </div>
          </div>
        </div>
      ) : (
